...
海量数据库部署服务器 192.168.120.69 root/Unicom#123
...
```
scp -r test.mp3 root@10.17.105.16:/data/html/audio 
```

```
scp -r test.mp3 root@192.168.120.44:/ntdata/rag-nginx/html/audio
```

### 电信算力服务器

电信 gpu 服务器 互联网地址 183.136.129.102 
卫生专网地址：10.199.14.102
用户名密码：star/Dc@2025!
